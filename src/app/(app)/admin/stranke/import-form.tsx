...
import { importClientsXlsx } from "./actions";

export function ImportClientsForm() {
  const [state, formAction, pending] = useActionState(importClientsXlsx, undefined);
  ...
  return (
    ...
    >
      ...
      <p className="text-xs text-gray-500 dark:text-gray-400">
        Prva vrstica naj vsebuje stolpec &quot;Ime&quot; (obvezno), poljubno tudi &quot;Naslov&quot; in
        &quot;Kontakt&quot;.
      </p>
      <input
        type="file"
