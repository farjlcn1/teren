  ...
  return (
    <div className="space-y-4 rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-800">
      ...
      <p className="text-xs text-gray-500 dark:text-gray-400">
        Generična povezava: pričakuje se GET zahteva, ki vrne JSON seznam objektov z polji externalId, plate.
        Prilagodi ob znanem zunanjem sistemu.
      </p>
      ...
      <div className="border-t border-gray-100 pt-3 dark:border-gray-700">
        ...
        <form action={syncAction}>
          ...
          {syncState?.success && (
            <p className="mb-2 text-sm text-green-600 dark:text-green-400">{syncState.success}</p>
          )}
          <button
            type="submit"
